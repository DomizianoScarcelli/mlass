...
if args.local_rank == 0:
    sbn_result = compare("comparing running_mean: ", bn.running_mean.data,
                         sbn.module.running_mean.data, error) and sbn_result
    sbn_result = compare("comparing running_variance: ", bn.running_var.data,
...
if args.local_rank == 0:
    ...
    compare("comparing bn vs sbn weight: ",
            bn.weight, sbn.module.weight, error)
