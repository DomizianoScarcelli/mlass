...
from lass_audio.jukebox.data.labels import EmptyLabeller
from lass_audio.jukebox.utils.torch_utils import empty_cache
from lass_audio.jukebox.utils.audio_utils import save_wav, load_audio
from lass_audio.jukebox.make_models import make_model
from lass_audio.jukebox.align import get_alignment
from lass_audio.jukebox.save_html import save_html
from lass_audio.jukebox.utils.sample_utils import split_batch, get_starts
...
def save_samples(model, device, hps, sample_hps):
    print(hps)
    from lass_audio.jukebox.lyricdict import poems, gpt_2_lyrics
