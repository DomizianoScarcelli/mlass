...
from lass_audio.jukebox.transformer.ops import LayerNorm
from lass_audio.jukebox.prior.autoregressive import ConditionalAutoregressive2D
from lass_audio.jukebox.prior.conditioners import Conditioner, LabelConditioner
from lass_audio.jukebox.data.labels import EmptyLabeller, Labeller

from lass_audio.jukebox.utils.torch_utils import assert_shape
from lass_audio.jukebox.utils.dist_utils import print_once
    ...
    def __init__(self, z_shapes, l_bins, encoder, decoder, level,
        ...
        if single_enc_dec:
            ...
            if self.n_tokens != 0 and self.use_tokens:
                from lass_audio.jukebox.transformer.ops import Conv1D
